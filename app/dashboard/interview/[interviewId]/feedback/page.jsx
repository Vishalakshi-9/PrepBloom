                ...
                {feedbackList.map((item, index) => (
                    <Collapsible key={index} className="border border-[#FBB6CE] rounded-xl shadow-sm bg-white">
                        ...
                        <CollapsibleContent className="p-4 bg-[#FFF9DB] rounded-b-xl space-y-3">
                            ...
                            <p className='text-blue-900'><strong className="text-[#0549a9]">Your Answer:</strong> {item.userAns}</p>
                            <p className='text-green-900'><strong className="text-[#095c2e]">Correct Answer:</strong> {item.correctAns}</p>
